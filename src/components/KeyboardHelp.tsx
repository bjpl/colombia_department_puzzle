      ...
      >
        ...
        <div id="keyboard-help-content" className="space-y-4">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <KeyBinding keys={['↑', '↓', '←', '→']} description="Mover departamento seleccionado" />
          ...
          <section>
            <h3 className="font-semibold text-lg text-gray-700 mb-2">⚡ Acciones Rápidas</h3>
            <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              💡 <strong>Tip:</strong> El juego es totalmente accesible con teclado.
              Los lectores de pantalla anunciarán automáticamente el progreso del juego.
            </p>
          </div>
        </div>
      </div>
