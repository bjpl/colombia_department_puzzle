...
These are universal operating principles that apply to all AI agents across all projects.
They establish the foundation for professional, ethical, and effective operation.
...
These directives are reusable across all projects. Copy this file to new repositories
to establish consistent AI agent behavior.

For project-specific implementations, see PROJECT_IMPLEMENTATION.md
